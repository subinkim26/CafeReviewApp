...
import com.example.cafereviewapp.MainActivity
import com.example.cafereviewapp.R
...
class LoginActivity : AppCompatActivity(),View.OnClickListener {
    ...
    private lateinit var btn_googleSignIn : Button
        ...
        firebaseAuth.signInWithCredential(credential)
            .addOnCompleteListener(this) { task ->
                if (task.isSuccessful) {
                    ...
                    Snackbar.make(login, "로그인에 실패하였습니다.", Snackbar.LENGTH_SHORT).show()
                }
            }
